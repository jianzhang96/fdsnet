...
__all__ = ['FeatureFusion','AttentionRefinmentModule','BiSeNet', 'get_bisenet', 'get_bisenet_resnet18_citys','get_bisenet_resnet18_mt_voc','main']
...
def get_bisenet(dataset='citys', backbone='resnet18', pretrained=False, root='/data/zhangj/.torch/models',
                pretrained_base=True,local_rank=0, **kwargs):
    acronyms = {
...
def get_bisenet_resnet18_mt_voc(**kwargs):
    return get_bisenet('mt_voc', 'resnet18', **kwargs)
...
def main():
    ...
    img = torch.randn(1, 3, 1440, 810)
    model = get_bisenet('phone_voc')
    model.eval()
    ...
    summary(model, input_size=(1, 3, 1440, 810))
