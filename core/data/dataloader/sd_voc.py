...
class SDVOCSegmentation(SegmentationDataset):
    """Pascal VOC Semantic Segmentation Dataset.
    ...
    def __init__(self, root='/data/zhangj/voc', split='train', mode=None, transform=None, **kwargs):
        super(SDVOCSegmentation, self).__init__(root, split, mode, transform, **kwargs)
    ...
    def classes(self):
        """Category names."""
        return ('background', 'inclusion', 'patches','scratches')


if __name__ == '__main__':
    dataset = SDVOCSegmentation()